    ...
    return (
        <div className="max-w-7xl mx-auto">
            <div className=" grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 justify-center py-10">
                <div className="p-10">
                    <h1 className="text-4xl font-bold text-blue-600 text-center pb-5">Create Account</h1>
                    <p className="text-gray-600 text-center">Create your account to continue</p>
                    <p className="text-center text-2xl text-blue-600 mt-6 mb-2 ">Already have an account</p>
                    <Link
                        href="/login"
